...
set video_encoder=E:\Work\video\bin\x264.kmod\x264.2705kMod.x86_64.exe
rem set video_encoder=bin\x265.exe

set "x264_loseless=--opencl --opencl-clbin %out_folder%x264.clbin --colorprim bt709 --transfer bt709 --colormatrix bt709 --qp 0 --keyint 999999 --min-keyint 0 --ref 16 --mixed-refs --no-fast-pskip --bframes 16 --b-adapt 2 --b-pyramid --weightb --direct auto --nf --subme 9 --trellis 2 --partitions all --8x8dct --me tesa --threads 2 --thread-input --aud --progress --no-psnr --no-ssim --rc-lookahead 150 --sync-lookahead 150 --non-deterministic --open-gop "

rem set "x264_stream=--opencl --opencl-clbin %out_folder%x264.clbin --colorprim bt709 --transfer bt709 --colormatrix bt709 --qp 24 --keyint 999999 --min-keyint 0 --threads 2 --thread-input --aud --progress --no-psnr --no-ssim --rc-lookahead 150 --sync-lookahead 150 --non-deterministic --open-gop --cabac"
...
rem echo Encoding %%~f pass 1
rem echo %video_encoder_keys%
rem %video_encoder% %%~f %video_encoder_keys% --pass 1 --qp 25 --ipratio 1.33 --pbratio 1.33 --output NUL --stats %out_folder%%%~nf.stats --index %%~nf.index 
echo Encoding %%~f pass last
%video_encoder% %%~f %x264_loseless% --output %out_folder%%%~nf.264 --index %%~nf.index 
