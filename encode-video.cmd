...
set in_files=*.wmv
set out_folder=
set encoder="bin\x264.2538kMod.x86_64.exe"

for %%f in (%in_files%) do (
echo %%~f
echo pass 1
%encoder% %%~f --opencl --input-res 1920x1080 --fps 30001/1001 --force-cfr --profile high --level 4.1 --pass 1 --qpmin 22 --qpmax 32 --qpstep 4 --bitrate 1200 --ratetol 10 --fade-compensate 1.0 --ipratio 1.1 --pbratio 1.3 --ref 6 --mixed-refs --mbtree 1 --no-fast-pskip --fgo 10 --scenecut 40 --keyint 300 --min-keyint 30 --rc-lookahead 120 --open-gop --bframes 9 --b-pyramid normal --b-adapt 1 --direct auto --8x8dct --no-dct-decimate --me umh --merange 24 --aq-mode 1 --aq-strength 0.5 --subme 9 --cabac --trellis 0 --weightp 2 --no-psy --cqm flat --sar 1:1 --deblock 1:1 --colormatrix bt709 --partitions i4x4,i8x8,p8x8,b8x8 --threads auto --lookahead-threads 1 --mvrange-thread -1 --sync-lookahead 150 --thread-input --demuxer-threads 1 --non-deterministic --cplxblur 20 --video-filter resize:width=1280,height=720,method=spline --output NUL --stats %out_folder%%%~nf.stats --index %%~nf.index --opencl-clbin %out_folder%x264.clbin
echo pass 2
%encoder% %%~f --opencl --input-res 1920x1080 --fps 30001/1001 --force-cfr --profile high --level 4.1 --pass 2 --qpmin 22 --qpmax 32 --qpstep 4 --bitrate 1300 --ratetol 10 --fade-compensate 1.0 --ipratio 1.1 --pbratio 1.3 --ref 6 --mixed-refs --mbtree 1 --no-fast-pskip --fgo 10 --scenecut 40 --keyint 300 --min-keyint 30 --rc-lookahead 120 --open-gop --bframes 9 --b-pyramid normal --b-adapt 1 --direct auto --8x8dct --no-dct-decimate --me umh --merange 24 --aq-mode 1 --aq-strength 0.5 --subme 9 --cabac --trellis 0 --weightp 2 --no-psy --cqm flat --sar 1:1 --deblock 1:1 --colormatrix bt709 --partitions i4x4,i8x8,p8x8,b8x8 --threads auto --lookahead-threads 1 --mvrange-thread -1 --sync-lookahead 150 --thread-input --demuxer-threads 1 --non-deterministic --cplxblur 20 --video-filter resize:width=1280,height=720,method=spline --output %out_folder%%%~nf.264 --stats %out_folder%%%~nf.stats --index %%~nf.index --opencl-clbin %out_folder%x264.clbin
